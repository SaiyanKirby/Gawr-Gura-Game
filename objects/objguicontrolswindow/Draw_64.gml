...
draw_text(x + width - 16, y + (height*10), fnGetButtonName(iCONFIRM));
draw_text(x + width - 16, y + (height*11), fnGetButtonName(iBACK));
draw_text(x + width - 16, y + (height*12), fnGetButtonName(iPAUSE));
